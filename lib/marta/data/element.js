...
document.marta_stop = function() {
  if (document.getElementById("marta_magic_div").getAttribute("martastyle") == "off"){
    ...
    document.getElementById("marta_hint").innerHTML = "<p>Go ahead! Marta is not watching.</p><p>All your actions <b>will not</b> be counted as an element definition</p><p>It will lasts until page will not be refreshed (or new opened). Or until you will not switch it off</p>";
  }
};
