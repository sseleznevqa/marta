...
function marta_add_field(title, what, key, marker) {
    ...
    divtest.setAttribute("martaclass", "marta_smthng");
    var headerDiv = marta_create_element(divtest, "div", {"martaclass": "marta_smthng", "class": "label", "id": "marta_title"+marta_room}, "ATTR");
    divtest.appendChild(headerDiv);
    var contentDiv = marta_create_element(divtest, "div", {"martaclass": "marta_smthng", "marta_style": "field_line", "class": "label", "id": "marta_staff"+marta_room}, "");
    var nameField = marta_create_element(contentDiv, "input", {"martaclass": "marta_smthng", "marta_style": "name_field", "class": "marta_s_name_field", "type": "text", "disabled": "disabled;", "id": "marta_name"+marta_room, "value": ""}, "");
    var valueField = marta_create_element(contentDiv, "input", {"martaclass": "marta_smthng", "marta_style": "value_field", "type": "text", "id": "marta_default_value"+marta_room, "value": ""}, "");
    var cancelButton = marta_create_element(contentDiv, "input", {"martaclass": "marta_smthng", "marta_style": "cancel_button", "type": "button", "id": "delete_marta_value"+marta_room, "value": "Delete"}, "");
    ...
    document.getElementById("delete_marta_value"+marta_room).onclick = function() {marta_delete_line(marta_room)};
...
function spaninize(string) {
  ...
  for (var i=0, max=everything.length; i < 2*max; i=i+2) {
    ...
    wrapper.onclick = function(e) {marta_touch(e)};
