...
document.marta_connect = function() {
    document.timeStart = new Date().getTime();
    while ((new Date().getTime()) - document.timeStart<500){};
    ...
    document.xmlHttp.open( "GET", document.martaUrl, true );
    document.xmlHttp.send( null );
};

setInterval(function(){document.marta_connect();}, 500);
