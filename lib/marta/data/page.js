...
function marta_add_field() {
    ...
    var cancelButton = marta_create_element(contentDiv, "input", {"martaclass": "marta_smthing", "martastyle": "cancel_button", "type": "button", "id": "delete_marta_value"+marta_room, "value": "Delete"}, "");
